...
object HostList extends App {
  if (args.length < 1) {
    ...
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.HostList apikey"`""")
  } else {
    val apikey = args(0)
...
object CreateHost extends App {
  if (args.length < 2) {
    println(s"[${Console.RED}error${Console.RESET}] apikey could not be found")
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.CreateHost apikey hostname"`""")
  } else {
    val apikey = args(0)
    val hostName = args(1)
    val mackerel = new Mackerel(apikey)
...
object GetHost extends App {
  if (args.length < 2) {
    ...
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.GetHost apikey hostid"`""")
  } else {
    val apikey = args(0)
    val hostId = args(1)
    val mackerel = new Mackerel(apikey)
...
object UpdateHost extends App {
  if (args.length < 3) {
    ...
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.UpdateHost apikey hostid newname"`""")
  } else {
    val apikey = args(0)
    val hostId = args(1)
    val newName = args(2)
...
object UpdateHostStatus extends App {
  if (args.length < 3) {
    ...
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.UpdateHostStatus apikey hostid newstatus"`""")
  } else {
    val apikey = args(0)
    val hostId = args(1)
...
object RetireHost extends App {
  if (args.length < 2) {
    println(s"[${Console.RED}error${Console.RESET}] apikey or hostid could not be found")
    println(s"""[${Console.RED}error${Console.RESET}] usage: `sbt "mackerel-client-scala-example/runMain com.github.krrrr38.mackerel4s.example.RetireHost apikey hostid"`""")
  } else {
    val apikey = args(0)
    val hostId = args(1)
    val mackerel = new Mackerel(apikey)
